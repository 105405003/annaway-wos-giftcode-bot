...
class BotOperations(commands.Cog):
        ...
        if custom_id == "alliance_control_messages":
                ...
                if custom_id == "assign_alliance":
                            ...
                            for admin_id, is_initial in admins:
                                ...
                                admin_options.append(
                                    discord.SelectOption(
                                        ...
                                        value=str(admin_id),
                                        description=f"{_('global_admin', 'PERMISSIONS') if is_initial == 1 else _('server_admin', 'PERMISSIONS')}",
                                    ...
                                    async def alliance_callback(alliance_interaction: discord.Interaction):
                                        try:
                                            ...
                                            success_embed = discord.Embed(
                                                ...
                                                description=(
                                                    f"{_('successfully_assigned_alliance', 'SUCCESS')}:\n\n"
                    ...
                    try:
                        ...
                        try:
                            ...
                            success_embed = discord.Embed(
                                title=f"✅ {_('administrator_successfully_added', 'SUCCESS')}",
                                description=(
                        ...
                        for admin_id, is_initial in admins:
                            ...
                            options.append(
                                discord.SelectOption(
                                    ...
                                    value=str(admin_id),
                                    description=f"{_('global_admin', 'PERMISSIONS') if is_initial == 1 else _('server_admin', 'PERMISSIONS')} - ID: {admin_id}",
                                    emoji="👑" if is_initial == 1 else "👤"
                                )
                            )
                            ...
                            try:
                                ...
                                async def confirm_callback(button_interaction: discord.Interaction):
                                    try:
                                        ...
                                        success_embed = discord.Embed(
                                            title=f"✅ {_('administrator_deleted_successfully', 'SUCCESS')}",
                                            description=(
                                    ...
                                    try:
                                        ...
                                        if success:
                                            success_embed = discord.Embed(
                                                ...
                                                description=(
                                                    f"{_('successfully_removed_alliance_permission', 'SUCCESS')}:\n\n"
                                                    f"**Admin:** {admin_name} ({admin_id})\n"
                                                    f"**Alliance:** {alliance_name} ({alliance_id})"
                                                ),
                                                color=discord.Color.green()
                ...
                for admin_id, is_initial in admins:
                    try:
                        ...
                        admin_info = (
                            f"👤 **Name:** {admin_name}\n"
                            f"🆔 **ID:** {admin_id}\n"
                            f"👑 **{_('role', 'PERMISSIONS')}:** {_('global_admin', 'PERMISSIONS') if is_initial == 1 else _('server_admin', 'PERMISSIONS')}\n"
            ...
            try:
                ...
                if not current_version or not new_version:
                    await interaction.response.send_message(
                        _("failed_to_check_updates", "ERRORS"), 
                        ephemeral=True
                    )
                    return
    ...
    async def show_bot_operations_menu(self, interaction: discord.Interaction):
        try:
            embed = discord.Embed(
                title=_("bot_operations", "MENU"),
                description=(
                    f"{_('please_choose_operation', 'BOT_OPERATIONS')}\n\n"
                    f"**{_('available_operations', 'BOT_OPERATIONS')}**\n"
                    f"{_('separator', 'BOT_OPERATIONS')}\n"
                    f"👥 **{_('admin_management', 'BOT_OPERATIONS')}**\n"
                    f"└ {_('manage_bot_administrators', 'BOT_OPERATIONS')}\n\n"
                    f"🔍 **{_('admin_permissions', 'BOT_OPERATIONS')}**\n"
                    f"└ {_('view_manage_admin_permissions', 'BOT_OPERATIONS')}\n\n"
                    f"🔄 **{_('bot_updates', 'BOT_OPERATIONS')}**\n"
                    f"└ {_('check_manage_updates', 'BOT_OPERATIONS')}\n"
                    f"{_('separator', 'BOT_OPERATIONS')}"
                ),
                color=discord.Color.blue()
            )
            ...
            view = discord.ui.View()
            view.add_item(discord.ui.Button(
                label=_("add_admin", "BOT_OPERATIONS"),
                emoji="➕",
                style=discord.ButtonStyle.success,
                custom_id="add_admin",
                row=1
            ...
            view.add_item(discord.ui.Button(
                label=_("remove_admin", "BOT_OPERATIONS"),
                emoji="➖",
                style=discord.ButtonStyle.danger,
            ...
            view.add_item(discord.ui.Button(
                label=_("view_administrators", "BOT_OPERATIONS"),
                emoji="👥",
            ...
            view.add_item(discord.ui.Button(
                label=_("assign_alliance_to_admin", "BOT_OPERATIONS"),
                emoji="🔗",
                style=discord.ButtonStyle.success,
            ...
            view.add_item(discord.ui.Button(
                label=_("delete_admin_permissions", "BOT_OPERATIONS"),
                emoji="➖",
                style=discord.ButtonStyle.danger,
            ...
            view.add_item(discord.ui.Button(
                label=_("transfer_old_database", "BOT_OPERATIONS"),
                emoji="🔄",
                style=discord.ButtonStyle.primary,
            ...
            view.add_item(discord.ui.Button(
                label=_("check_for_updates", "BOT_OPERATIONS"),
                emoji="🔄",
                style=discord.ButtonStyle.primary,
            ...
            view.add_item(discord.ui.Button(
                label=_("log_system", "BOT_OPERATIONS"),
                emoji="📋",
                style=discord.ButtonStyle.primary,
            ...
            view.add_item(discord.ui.Button(
                label=_("alliance_control_messages", "BOT_OPERATIONS"),
                emoji="💬",
                style=discord.ButtonStyle.primary,
